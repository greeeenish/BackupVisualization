...
export const initStorageCube = (value, fn) => {
  return new Promise(function (resolve, reject) {
    let mtlLoader = new MTLLoader();
    mtlLoader.setPath(process.env.BASE_URL + "object/4/");
    mtlLoader.load('4.mtl', (materials) => {
      materials.preload();
      let objLoader = new OBJLoader();
      objLoader.setMaterials(materials);
      objLoader.setPath(process.env.BASE_URL + "object/4/");
      objLoader.load('4.obj', (object) => {
